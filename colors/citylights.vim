...
hi StatusLine ctermfg=67 ctermbg=59 cterm=bold guifg=#91acc1 guibg=#35434e gui=bold
hi StatusLineNC ctermfg=67 ctermbg=59 cterm=NONE guifg=#91acc1 guibg=#35434e gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#313a42 gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=67 ctermbg=64 cterm=bold guifg=#91acc1 guibg=#44830e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#890709 guibg=NONE gui=NONE
hi DiffChange ctermfg=67 ctermbg=23 cterm=NONE guifg=#91acc1 guibg=#1e385a gui=NONE
hi DiffText ctermfg=67 ctermbg=24 cterm=bold guifg=#91acc1 guibg=#204a87 gui=bold
...
hi Special ctermfg=67 ctermbg=NONE cterm=NONE guifg=#91acc1 guibg=NONE gui=NONE
...
hi Title ctermfg=67 ctermbg=NONE cterm=bold guifg=#91acc1 guibg=NONE gui=bold
...
hi rubyArgument ctermfg=81 ctermbg=NONE cterm=NONE guifg=#5ec4ff guibg=NONE gui=NONE
hi rubyBlockArgument ctermfg=81 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi rubyAttribute ctermfg=80 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi rubyFunction ctermfg=80 ctermbg=NONE cterm=NONE guifg=#33ced8 guibg=NONE gui=NONE
hi rubyInterpolationDelimiter ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubySymbol ctermfg=115 ctermbg=NONE cterm=NONE guifg=#e27e8d guibg=NONE gui=NONE
hi rubyConstant ctermfg=67 ctermbg=NONE cterm=NONE guifg=#a9c2d6 guibg=NONE gui=NONE
hi rubyStringDelimiter ctermfg=69 ctermbg=NONE cterm=NONE guifg=#539afc guibg=NONE gui=NONE
hi rubyBlockParameter ctermfg=180 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi rubyInstanceVariable ctermfg=68 ctermbg=NONE cterm=NONE guifg=#7e9aaf guibg=NONE gui=NONE
hi rubyInclude ctermfg=81 ctermbg=NONE cterm=NONE guifg=#5ec4ff guibg=NONE gui=NONE
hi rubyGlobalVariable ctermfg=67 ctermbg=NONE cterm=NONE guifg=#a9d1d6 guibg=NONE gui=NONE
...
hi rubyClassVariable ctermfg=67 ctermbg=NONE cterm=NONE guifg=#a9d1d6 guibg=NONE gui=NONE
...
hi rubyPseudoVariable ctermfg=67 ctermbg=NONE cterm=NONE guifg=#a9d1d6 guibg=NONE gui=NONE
hi rubyRailsUserClass ctermfg=67 ctermbg=NONE cterm=NONE guifg=#91acc1 guibg=NONE gui=NONE
...
hi yamlAnchor ctermfg=67 ctermbg=NONE cterm=NONE guifg=#91acc1 guibg=NONE gui=NONE
hi yamlAlias ctermfg=67 ctermbg=NONE cterm=NONE guifg=#91acc1 guibg=NONE gui=NONE
